    ...
    public partial class Initial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ShoppingCartItemsItemId = table.Column<int>(type: "int", nullable: false),
                    shoppingCartsShoppingCartId = table.Column<string>(type: "nvarchar(450)", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_ItemShoppingCart", x => new { x.ShoppingCartItemsItemId, x.shoppingCartsShoppingCartId });
                    table.ForeignKey(
                        name: "FK_ItemShoppingCart_Items_ShoppingCartItemsItemId",
                        column: x => x.ShoppingCartItemsItemId,
